...
public class RemoveGreaterItem implements ActionWhenSelected {
    ...
    public void executeCommand(JPanel jPanel, ConnectionAndExecutorManager caeManager) {
        ...
        CommandResult result = caeManager.executeCommand(ConstantsLanguage.REMOVE_GREATER_COMMAND, spMar, null);
